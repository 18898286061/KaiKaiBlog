...
4. 现在我们在本地新建一个文件夹*（文件名!没必要!一致）*，与Github的库“连接”起来,这样我们可以在后续将自己在本地写的代码推送至库中。
...
5. 然后右键这个文件夹答得Git Bash Here选项，点击打开我们的Git Bash命令行后； 将以上命令一列一列输入至命令行中。
...
http://m.qpic.cn/psb?/V10GprTj1Jz8DT/sYjbo7m7c6J25PDDmEVq5kTBfS6*.b8VUMOt*jMbZo4!/b/dDUBAAAAAAAA&bo=FQI9AQAAAAADBwk!&rf=viewer_4)
...
11. 接着我们将这行打印出来的“密码”复制进入刚刚的Key里，而Title我们可以随便填写。 点击绿色按钮提交以后；我们回到Git Bash输入刚才失败的的那行命令： 
...
13. 我举个栗子，我所选择的是修改了代码（你再做删除或者添加文件修改代码的操作都会触发更改），修改过后保存代码，然后点击我们的**源代码管理按钮**之后，我们注释上我们这次提交做了什么，接着点击“√”提交，然后点击"..."的推送选项，然后我们就可以在GitHub的库上面发现我们的*提交注释和已经修改了的代码*。
...
这样你和别人就可以在你的Github库上直接点击，预览到你写的网页了。
